    ...
    <div className="flex flex-col min-h-screen w-full bg-white text-slate-900 font-sans">
      ...
      <main className="flex-1 py-20 px-6 md:px-12 max-w-5xl mx-auto flex flex-col gap-12 font-outfit">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mt-6">
          <div className="md:col-span-2 bg-white border border-slate-200/90 shadow-sm rounded-2xl p-8 flex flex-col gap-6">
            <h2 className="text-2xl font-bold font-space text-slate-900">
              Meet Our Owners
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="rounded-xl border border-slate-200 bg-slate-50 p-5">
                  ...
                  <p className="text-sm text-amber-600 font-bold mt-1">{owner.role}</p>
          ...
          <div className="bg-white border border-slate-200/90 shadow-sm rounded-2xl p-8 flex flex-col gap-6">
            <h3 className="text-xl font-bold font-space text-amber-600">
              Why Choose Us?
            </h3>
            <ul className="flex flex-col gap-4 text-sm font-semibold tracking-wide text-slate-700">
